...
// ---------------------------------------------------------------------------
export async function generate(userCount = 12, listingCount = 24, reservationCount = 6) {
  ...
  console.log(`✨ Total Users Added: ${createdUsers.length} | Listings Added: ${createdListings.length} | Active Deals: ${reservationCount}`);
