...
async function main() {
  ...
  const userDefinitions = [
    ...
    {
      name: 'Khan Trading Co (Seller)',
      email: 'seller@demo.com',
      businessName: 'Khan Wholesale Traders',
      phone: '9820998877',
      lat: 19.1136,
      lng: 72.8697,
    ...
    {
      name: 'Rajesh General Store (Buyer)',
      email: 'buyer@demo.com',
      businessName: 'Rajesh General Retail Store',
      phone: '9820776655',
      lat: 19.0596,
      lng: 72.8295,
