      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <CheckCircle2 size={18} color="var(--sb-primary, #6F8F69)" />
        ...
        <form onSubmit={handleSubmit} style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 18 }}>
          <p style={{ fontFamily: 'Work Sans, sans-serif', fontSize: 13, color: 'var(--sb-text-secondary, #4F5A51)', lineHeight: 1.5, margin: 0 }}>
            Confirm goods receipt or physical delivery. You can optionally attach proof (invoice, signed receipt, or goods photo).
          </p>

          <div style={{
            border: '2px dashed var(--sb-border-strong, #BEC9BA)', borderRadius: 6, padding: '24px 16px',
            display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
            textAlign: 'center', background: 'var(--sb-surface-soft, #F2F6EF)', position: 'relative', cursor: 'pointer',
          }}>
            <input
              type="file"
              accept="image/*"
            ...
            {previewUrl ? (
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
                <img
                  src={previewUrl}
                  alt="Proof Preview"
                  style={{ maxHeight: 150, borderRadius: 4, objectFit: 'contain', border: '1px solid var(--sb-border, #D8E0D5)' }}
                />
                <p style={{ fontFamily: 'Work Sans, sans-serif', fontSize: 12, color: 'var(--sb-primary, #6F8F69)', display: 'flex', alignItems: 'center', gap: 4, margin: 0 }}>
              ...
              <>
                <div style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: 'var(--sb-primary, #6F8F69)', marginBottom: 12,
                }}>
                  <Upload size={20} />
                </div>
                <p style={{ fontFamily: 'Work Sans, sans-serif', fontSize: 13, fontWeight: 600, color: 'var(--sb-text-primary, #182018)', margin: 0 }}>
                  Upload Handover Proof (Optional)
                </p>
                <p style={{ fontFamily: 'Work Sans, sans-serif', fontSize: 11, color: 'var(--sb-text-muted, #7A847A)', margin: '4px 0 0' }}>
