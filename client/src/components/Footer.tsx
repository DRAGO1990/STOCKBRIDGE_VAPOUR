...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0b0e1f] border-t border-[#3f4b81]/50 mt-auto text-slate-400 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-white text-base">Stock<span className="text-teal-400">Bridge</span></span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li className="flex items-center gap-1.5"><RefreshCw size={12} className="text-teal-400" /> Surplus Batch Liquidation</li>
          ...
          <div>
            ...
            <div className="mt-3 inline-flex items-center gap-1.5 text-[11px] text-teal-300 bg-teal-950/60 border border-teal-800/60 px-2.5 py-1 rounded-lg">
              <ShieldCheck size={14} className="text-teal-400" /> 100% Verified Merchant Safe
            </div>
          </div>
        </div>

        <div className="mt-8 pt-6 border-t border-[#3f4b81]/40 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
