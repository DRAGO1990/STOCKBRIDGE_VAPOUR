...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-16">
      {/* Hero Banner */}
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#1A1330] via-[#1A1330] to-[#0F0B1A] border border-[#2B1F4D] p-8 md:p-12 shadow-2xl">
        <div className="absolute -right-20 -top-20 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -left-20 -bottom-20 w-96 h-96 bg-pink-500/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 max-w-3xl space-y-4">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight leading-tight">
            Turn Excess Inventory Into <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-300 to-amber-300">Revenue Before It Becomes Dead Stock</span>
          </h1>
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3">
            <Link
              to="/create-listing"
              className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-400 hover:to-pink-400 text-navy-950 font-bold rounded-xl shadow-lg shadow-purple-500/25 transition-all transform hover:-translate-y-0.5"
            >
              Post Surplus Inventory
            </Link>
            <Link
              to="/match"
              className="px-6 py-3 bg-[#2B1F4D]/80 hover:bg-[#2B1F4D] text-white border border-[#2B1F4D] font-semibold rounded-xl transition-all flex items-center gap-2"
            >
        ...
        <div className="mt-8 pt-6 border-t border-[#2B1F4D]/50 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          <div className="p-3 bg-[#0F0B1A]/40 rounded-xl border border-[#2B1F4D]/30">
            <p className="text-xl md:text-2xl font-extrabold text-purple-400">20+ Lots</p>
            <span className="text-[11px] text-slate-400">Active Surplus Batches</span>
          </div>
          <div className="p-3 bg-[#0F0B1A]/40 rounded-xl border border-[#2B1F4D]/30">
            <p className="text-xl md:text-2xl font-extrabold text-pink-400">4 Cities</p>
      ...
      {/* Filter & Search Bar */}
      <section className="bg-[#1A1330] border border-[#2B1F4D] p-5 rounded-2xl shadow-xl space-y-4">
        <div className="flex flex-col md:flex-row items-center gap-3">
          ...
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full bg-[#0F0B1A] border border-[#2B1F4D] rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-purple-400 transition-colors"
            />
          </div>
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <div className="relative flex-1 md:w-52">
              ...
              <select
                ...
                className="w-full bg-[#0F0B1A] border border-[#2B1F4D] rounded-xl pl-9 pr-8 py-2.5 text-xs font-semibold text-slate-200 focus:outline-none focus:border-purple-400 appearance-none cursor-pointer"
              >
                {CITIES.map((c) => (
            ...
            <div className="relative flex-1 md:w-44">
              ...
              <select
                ...
                className="w-full bg-[#0F0B1A] border border-[#2B1F4D] rounded-xl pl-9 pr-8 py-2.5 text-xs font-semibold text-slate-200 focus:outline-none focus:border-purple-400 appearance-none cursor-pointer"
              >
                <option value="all" className="bg-[#1A1330]">All Urgencies</option>
                <option value="high" className="bg-[#1A1330]">🔥 High Urgency</option>
                <option value="medium" className="bg-[#1A1330]">⚡ Medium Urgency</option>
                <option value="low" className="bg-[#1A1330]">Standard Lot</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            ...
            <span className="text-xs font-semibold px-2 py-0.5 bg-[#2B1F4D] text-purple-300 rounded-full border border-[#2B1F4D]">
              {totalCount} lots
            </span>
          </h2>
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Array.from({ length: 6 }).map((_, i) => (
              <div
                key={i}
                className="bg-[#1A1330] border border-[#2B1F4D] rounded-2xl p-6 h-64 animate-pulse"
              />
            ))}
          </div>
        ) : listings.length === 0 ? (
          <div className="bg-[#1A1330] border border-[#2B1F4D] rounded-2xl p-12 text-center max-w-lg mx-auto space-y-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-purple-500 text-navy-950 font-semibold text-xs rounded-xl shadow-md cursor-pointer hover:bg-purple-400"
            >
              Reset All Filters
            </button>
          </div>
